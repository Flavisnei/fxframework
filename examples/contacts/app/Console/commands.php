...
return [new class extends Command {
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int {
        ...
        if (!is_dir($directory) && !mkdir($directory, 0770, true) && !is_dir($directory)) { throw new RuntimeException('Falha ao criar storage.'); }
        (new Example\Contacts\ContactStore(new PDO('sqlite:' . $directory . '/contacts.sqlite')))->install();
